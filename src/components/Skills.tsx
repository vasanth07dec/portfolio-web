      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-3 gap-8 mb-16">
          {skillCategories.map((category, categoryIndex) => (
            ...
            >
              <div className="mb-6">
                <div className={`inline-flex items-center space-x-3 p-3 rounded-lg bg-gradient-to-r ${category.color} mb-4`}>
                  <div className="text-white text-2xl">
                    {category.icon}
                  </div>
                  <Title level={4} className="text-white mb-0 font-mono">
                    {category.title}
                  </Title>
                </div>
              </div>
              ...
              <div className="grid grid-cols-2 gap-3">
                {category.skills.map((skill, skillIndex) => (
                  <div key={skillIndex} className="bg-gray-800 p-3 rounded-lg border border-gray-600 hover:border-[rgb(158,206,106)] transition-all duration-300">
                    <Text className="text-[rgb(122,162,247)] font-mono font-medium text-sm">
                      {skill.name}
                    </Text>
                  </div>
                ))}
